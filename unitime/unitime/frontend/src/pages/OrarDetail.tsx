...
export default function OrarDetail() {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <p style={{ marginBottom: '12px', lineHeight: 1.5 }}>{item.descriere}</p>
                <p style={{ marginBottom: '8px' }}>
                    <strong>Locație:</strong> {item.locatie}
                </p>
                <p style={{ marginBottom: '24px' }}>
                    <strong>Data:</strong> {item.data} @ {item.ora}
                </p>
                <button
                    onClick={() => navigate('/orar')}
                    style={{
                        padding: '12px 24px',
                        border: 'none',
                        borderRadius: '50px',
